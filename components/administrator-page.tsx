...
import { Toaster } from "@/components/ui/toaster" // ⬅️ Mount the toaster
...
export default function AdministratorPage() {
  ...
  if (!loading && (!user || (user.role && user.role.toLowerCase() != "admin"))) {
    return (
      <>
        ...
        <Toaster /> {/* ensure toasts still render if this page is hit */}
      </>
    )
  }
  ...
  if (showEditUsersPage) {
    return (
      <>
        ...
        <Toaster /> {/* toasts for edit/delete actions */}
      </>
    )
  }
  ...
  return (
    <>
      ...
      <Toaster /> {/* ⬅️ this renders all toast notifications on this page */}
    </>
  )
}
